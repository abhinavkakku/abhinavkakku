...
image: {
  src: "/images/htb-Cronos.png",
  alt: "HackTheBox Bashed Walkthrough",
}
description: HackTheBox Cronos machine is based on a old CMS vulnerability and sample privilege escalation due to permissions on file.
draft: true
category: HackTheBox
---
